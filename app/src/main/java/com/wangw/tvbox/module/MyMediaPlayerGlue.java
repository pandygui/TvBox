...
public class MyMediaPlayerGlue extends PlaybackControlGlue implements
...
//    private Action mSelectedAction; // the action which is currently selected by the user
    ...
    private MyPlayerCallback mMyPlayerCallback;
    ...
    protected void onAttachedToHost(PlaybackGlueHost host) {
        ...
        if (host instanceof SurfaceHolderGlueHost) {
            ((SurfaceHolderGlueHost) host).setSurfaceHolderCallback(
                    new MyMediaPlayerGlue.VideoPlayerSurfaceHolderCallback());
        }
    }
        ...
        if (mInitialized) {
            ...
            if (callbacks != null) {
                for (PlayerCallback callback : callbacks) {
                    callback.onPreparedStateChanged(MyMediaPlayerGlue.this);
                }
            }
        }
    }
    ...
    private void prepareMediaForPlaying() {
        ...
        mPlayer.setOnVideoSizeChangedListener(new MediaPlayer.OnVideoSizeChangedListener() {
            ...
            public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
                if (mMyPlayerCallback != null){
                    mMyPlayerCallback.onVideoSizeChanged(mp,width,height);
                }
            }
        });
...
//        }
    ...
    public MyPlayerCallback getMyPlayerCallback() {
        return mMyPlayerCallback;
    }

    public void setMyPlayerCallback(MyPlayerCallback myPlayerCallback) {
        mMyPlayerCallback = myPlayerCallback;
    }
